...
def _get_teacher_sampling_params(
    ...
    # if teacher_model_config.inference.name == "vllm" and temperature != 1.0:
    if temperature != 1.0:
        raise NotImplementedError("vLLM prompt_logprobs currently requires teacher inference.temperature=1.0.")
