...
## News
- [September 2026] **We open-sourced our EAGLE3 Draft-OPD implementation.** Try our newest model: [`bingyang-lei/qwen3-4b-eagle3-thinking-draftopd`](https://huggingface.co/bingyang-lei/qwen3-4b-eagle3-thinking-draftopd), and see the [training script](https://github.com/Simplified-Reasoning/Draft-OPD/blob/main/verl/examples/on_policy_distillation_trainer/run_qwen_eagle3.sh).
