...
from sglang.srt.managers.customized_info_utils import update_customized_info_meta
...
class TokenizerManager(TokenizerCommunicatorMixin, TokenizerManagerMultiItemMixin):
    ...
    def _handle_batch_output(
        ...
        for i, rid in enumerate(recv_obj.rids):
            ...
            use_stream_output = self.server_args.stream_output and is_stream
            ...
            update_customized_info_meta(
                meta_info=meta_info,
                state=state,
                recv_customized_info=getattr(recv_obj, "customized_info", None),
                recv_index=i,
                use_stream_output=use_stream_output,
                emit_accumulated=is_finished,
            )
